...
import com.learn.summer.web.ModelAndView;
...
public class MvcController {
    ...
    ModelAndView product(@PathVariable("id") String id, @RequestParam("name") String name) {
        return new ModelAndView("/product.html", Map.of("name", name,
                "product", Map.of("id", id, "name", "Summer Software")));
    }
